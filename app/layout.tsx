...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'in hand salary calculator india', 'pf calculator 2025', 'hra exemption calculator',
    'gratuity calculator india', 'income tax calculator FY 2026-27',
    'new tax regime calculator 2025', 'take home salary calculator india',
    'salary calculator FY 2026-27', '10 lpa in hand salary', '15 lpa in hand salary',
    '12 lpa in hand salary', '20 lpa in hand salary', '5 lpa in hand salary',
    'monthly salary calculator india', 'net salary calculator', 'ctc calculator india',
    'epf calculator india', 'salary after tax india', 'notice period buyout calculator',
    'new vs old tax regime 2025', 'section 87a rebate 2025', 'fresher salary calculator india',
  ],
  ...
  openGraph: {
    ...
    title: 'PayCalc Pro – Free Salary Calculator India | FY 2026-27',
    description: 'Calculate CTC to in-hand salary, PF, HRA & income tax instantly. Updated for FY 2026-27.',
...
const websiteSchema = {
  ...
  name: 'PayCalc Pro',
  url: 'https://paycalcpro.online',
  description: 'Free salary calculators for Indian professionals — FY 2026-27',
  potentialAction: {
    '@type': 'SearchAction',
    ...
    <html lang="en-IN" className={inter.variable}>
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          '@context': 'https://schema.org',
          '@graph': [
            { '@type': 'WebApplication', name: 'CTC to In-Hand Salary Calculator', url: 'https://paycalcpro.online/ctc-to-inhand', applicationCategory: 'FinanceApplication', operatingSystem: 'Web', offers: { '@type': 'Offer', price: '0', priceCurrency: 'INR' }, description: 'Convert annual CTC to monthly in-hand salary with full PF, HRA, tax breakdown for FY 2026-27.' },
            { '@type': 'WebApplication', name: 'In-Hand Salary Calculator', url: 'https://paycalcpro.online/in-hand-salary-calculator', applicationCategory: 'FinanceApplication', operatingSystem: 'Web', offers: { '@type': 'Offer', price: '0', priceCurrency: 'INR' }, description: 'Calculate monthly take-home salary from CTC with variable pay support. FY 2026-27.' },
            { '@type': 'WebApplication', name: 'Income Tax Calculator India FY 2026-27', url: 'https://paycalcpro.online/tax-estimator', applicationCategory: 'FinanceApplication', operatingSystem: 'Web', offers: { '@type': 'Offer', price: '0', priceCurrency: 'INR' }, description: 'Compare new vs old tax regime for FY 2026-27. Includes 87A rebate, variable pay, NPS, HRA.' },
