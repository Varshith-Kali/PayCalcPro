  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 text-slate-700 leading-relaxed">
        {[
          { title: '1. Acceptance of Terms', body: 'By accessing and using PayCalc Pro (paycalcpro.com), you accept and agree to be bound by these Terms of Use. If you do not agree to these terms, please do not use our website.' },
          ...
          { title: '9. Contact', body: 'For questions about these terms, contact us at hello@paycalcpro.com.' },
        ].map((s, i) => (
          <div key={i}>
